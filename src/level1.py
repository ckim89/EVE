...
def init(filename):
    ...
    floor = pygame.image.load('../images/TILE_FLOOR_2.jpg').convert()
    wall = pygame.image.load('../images/TILE_WALL_2.jpg').convert()
    dim = pygame.transform.scale(pygame.image.load('../images/TILE_PORTAL1.jpg').convert(),(50,50))
    ground = pygame.transform.scale(pygame.image.load('../images/BKG_ICE_TILE.jpg').convert(),(50,50))
    decor1 = pygame.image.load('../images/LEVEL1/DECOR_1.png').convert_alpha()
    decor2 = pygame.image.load('../images/LEVEL1/DECOR_2.png').convert_alpha()
    decor3 = pygame.image.load('../images/LEVEL1/DECOR_3.png').convert_alpha()
    decor5 = pygame.image.load('../images/LEVEL1/DECOR_5.png').convert_alpha()

...
def init(filename):
    ...
    decor1 = pygame.image.load('../images/LEVEL2/DECOR_1.png').convert_alpha()
    decor2 = pygame.image.load('../images/LEVEL2/DECOR_2.png').convert_alpha()
    decor3 = pygame.image.load('../images/LEVEL2/DECOR_3.png').convert_alpha()
    decor5 = pygame.image.load('../images/LEVEL2/DECOR_5.png').convert_alpha()

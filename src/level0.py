...
def init(filename):
    ...
    floor = pygame.image.load('../images/TILE_FLOOR.jpg').convert()
    wall = pygame.image.load('../images/TILE_WALL.jpg').convert()
    dim = pygame.transform.scale(pygame.image.load('../images/TILE_PORTAL1.jpg').convert(),(50,50))
    ground = pygame.image.load('../images/BKG_BARREN_TILE.png').convert_alpha()
    decor1 = pygame.image.load('../images/LEVEL0/DECOR_1.png').convert_alpha()
    decor2 = pygame.image.load('../images/LEVEL0/DECOR_2.png').convert_alpha()
    decor3 = pygame.image.load('../images/LEVEL0/DECOR_3.png').convert_alpha()
    decor5 = pygame.image.load('../images/LEVEL0/DECOR_5.png').convert_alpha()
